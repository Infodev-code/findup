        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/formations" className="text-gray-300 hover:text-white transition-colors duration-300">
                  Formations
                </Link>
              </li>
              <li>
                <Link href="/jobs" className="text-gray-300 hover:text-white transition-colors duration-300">
                  Jobs Étudiants
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href={`mailto:${siteConfig.contact.email}`} className="text-gray-300 hover:text-white transition-colors duration-300">
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href={`tel:${siteConfig.contact.phone.replace(/\s/g, '')}`} className="text-gray-300 hover:text-white transition-colors duration-300">
      ...
      <div className="bg-gray-800 py-6 border-t border-gray-700">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">
            &copy; {currentYear} FindUp. Tous droits réservés.
          </p>
          <div className="mt-4 md:mt-0 flex items-center">
            <p className="text-sm text-gray-400 flex items-center">
              <span className="mr-2">Développé par des étudiants algériens pour des étudiants algériens</span>
            </p>
          </div>
        </div>
      </div>
